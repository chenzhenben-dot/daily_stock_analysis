...
historical production defaults in ``app.py``. They never touch the network,
the trigger pipeline, or any production data. Run them with::
...
def _load_app(env):
    """Load the app module from scratch with the supplied env vars."""
    saved = {key: os.environ.get(key) for key in env}
    module_name = "er_app_under_test"
